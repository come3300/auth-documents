...
> 
> 
> ![image.png](attachment:fd63f5b3-184d-4090-afd6-a665e35dfce3:image.png)
> 
...
![image.png](attachment:45257849-ead9-4dae-8150-a463eaa11e71:image.png)

### 2. パスワード7文字で登録

→ 「パスワードは8文字以上で入力してください」

![image.png](attachment:9c6299db-1b8a-40a5-94f7-76584b171571:image.png)

### 3. メールアドレスが不正

→ 「正しいメールアドレスを入力してください」

![image.png](attachment:7076d5e2-059f-4b2e-9877-90c4953ad705:image.png)

### 4. 全角のユーザー名・パスワード

→ 「半角英数字で入力してください」

![image.png](attachment:fc981ec2-0357-4957-9106-930955aa911b:image.png)

### 5. 同じメールアドレスで登録

→ 「既に登録されているメールアドレスです」

![image.png](attachment:03e8295f-9d07-4a3d-b7d8-1a6da5ba9417:image.png)
